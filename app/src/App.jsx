    ...
    <div className={style.mainWrapper}>
       ...
       <main>
        ...
        <section className={style.about}>
          ...
          <div className={style.right}>
            <h1>About Us</h1>
            <p className={style.additionalInfo}>All of our furniture uses the best materials and choices for our customers.All of our furniture uses the best materials </p>
            <div className={style.aboutBlock}>
              <img src={about1} alt='about1'/>
              <div className={style.text}>
                <p className={style.textTitle}>Best Quality</p>
                <p className={style.textDescription}>All of our furniture uses the best materials and choices</p>
              </div>
            </div>
            <div className={style.aboutBlock}>
            ...
            <div className={style.block}>
              ...
              <div className={style.textPopular}>
                ...
                <div className={style.icons}>
                  <div className={style.heart}><img src={heart} alt='heart'/></div>
                  <div className={style.share}><img src={share} alt="share" /></div>
                </div>
              </div>
